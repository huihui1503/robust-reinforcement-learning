...
@dataclasses.dataclass #class for store data
...
class FrameStackingWrapper(EnvironmentWrapper):
  ...
  def __init__(
    ...
    #creates one FrameStacker object for every leaf in the observation specification
    ...
    #apply framestacker on every leaf in original_spec
    # get new specification of every leaf in observation.
...
class FrameStacker:
  ...
  def reset(self):
    # When you append a new element and it’s already full:
