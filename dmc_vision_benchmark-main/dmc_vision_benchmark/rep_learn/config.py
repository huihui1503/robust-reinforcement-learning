...
def get_config() -> ml_collections.ConfigDict:
  ...
  config.save_to_folder = "/scratch/cor54gyp/rep_learn"
...
#   config.data.dataset_dir = "/tmp/dmc_vision_bench_data/dmc_vision_benchmark/dmc_vision_benchmark/" 
  config.data.dataset_dir = "/scratch/cor54gyp/dmc_vision_bench_data/dmc_vision_benchmark/"
 # pylint: disable=line-too-long
  ...
  config.online_eval.background_dataset_path = "/scratch/cor54gyp/dmc_vision_bench_data/dmc_vision_benchmark/kubric_movi-d/"  # pylint: disable=line-too-long
